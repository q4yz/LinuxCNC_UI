...
export const AUTOCOMPLETE_COMMANDS = [
  ...
  { label: 'M3',  command: 'M3',   category: 'mcode',  description: 'Spindle on (CW)' },
  { label: 'M4',  command: 'M4',   category: 'mcode',  description: 'Spindle on (CCW)' },
  { label: 'M5',  command: 'M5',   category: 'mcode',  description: 'Spindle off' },
  ...
  { label: 'M51', command: 'M51',  category: 'mcode',  description: 'Spindle override enable' },
