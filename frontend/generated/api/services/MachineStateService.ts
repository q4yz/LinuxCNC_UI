...
export class MachineStateService {
    ...
    public static setMachineState(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/modules/machine/state',
            body: requestBody,
    ...
    public static setMachineMode(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/modules/machine/mode',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                422: `Validation Error`,
    ...
    public static homeAxis(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/modules/machine/home',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                422: `Validation Error`,
    ...
    public static runMdiCommand(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/modules/machine/mdi',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                422: `Validation Error`,
    ...
    public static setTargetTemperature(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/modules/temperature/sensors/{name}/target',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                422: `Validation Error`,
