...
:mod:`backend.macros_parser` and its re-export from
:mod:`macros`.
...
class TestTicketExample:
    ...
    def test_returns_three_blocks_in_order(self):
        from macros_parser import parse_macro
...
class TestMalformedInput:
    ...
    def test_unclosed_open_brace_raises(self):
        from macros_parser import MacroParseError, parse_macro
...
class TestStructural:
    ...
    def test_parse_macro_exported_from_package(self):
        # ``macros_parser`` exposes ``parse_macro`` as the canonical
        # entry point.
        from macros_parser import parse_macro
    ...
    def test_block_is_typed_dict(self):
        from macros_parser import Block
    ...
    def test_macro_parse_error_is_value_error(self):
        from macros_parser import MacroParseError
    ...
    def test_parser_source_contains_no_execution_calls(self):
        ...
        this test file.
        """
        import macros_parser as parser_module  # noqa: F401
    ...
    def test_parser_module_has_no_third_party_imports(self):
        ...
        """
        import macros_parser as parser_module
