...
def machine_app(tmp_data_root, clean_env, isolated_roots, monkeypatch):
    ...
    from services.domain_file_services import ConfigFileService, MachineFileService
...
def test_pin_catalog_from_services_uses_cached_containers(isolated_roots):
    """The default source is the services' cached pin containers."""
    ...
    tools_service._halpins_cache = [spindle]
    state_service = get_state_service()
    state_service._Estop = estop
