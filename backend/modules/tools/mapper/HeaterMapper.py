...
from modules.tools.dtos.HeaterDto import HeaterStateDTO, HeaterPins, HeaterSettingsDTO
...
if TYPE_CHECKING:
    from modules.tools.ToolRouter import HeaterCommand, HeaterCommandStateResponse
