...
implementation discovered under :mod:`backend.services.machineconfig`.
...
logger = logging.getLogger("backend.services.machineconfig")
...
def iter_compiler_classes() -> Iterable[type[Compiler]]:
    ...
    The discovery walks :mod:`backend.services.machineconfig`,
