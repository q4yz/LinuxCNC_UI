...
from models.machineconfig import Extruder, MachineConfigGraph, MCU
from machineconfig_parser import derive_fan_name, split_pin
...
logger = logging.getLogger("backend.services.machineconfig.config_txt_generator")
