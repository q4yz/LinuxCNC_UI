...
:mod:`axis.jog_service` and force-stops expired
axes by calling :func:`axis.jog_service.stop_axis`.
...
async def _loop() -> None:
    ...
    :mod:`axis.jog_service` for the active-jog
...
def stop_watchdog() -> None:
    ...
    Idempotent. Clears :data:`axis.jog_service._active_jogs`
